...
menu() {
    ...
    echo -e "${BOLD}${GREEN}║ 2) ${WHITE}Install Warp [armeabi-vv7]${RESET}${BOLD}${CYAN}               ║${RESET}"
    ...
    echo -e "${BOLD}${RED}║ 9) ${WHITE}Revised by Diana${RESET}${BOLD}${RED}                         ║${RESET}"
    echo -e "${BOLD}${CYAN}╠═════════════════════════════════════════════╣${RESET}"
    echo -e "${BOLD}${RED}║ 0) Exit${BOLD}${RED}                                     ║${RESET}"
    echo -e "${BOLD}${CYAN}╚═════════════════════════════════════════════╝${RESET}"
